    ...
    def get_ejercicios_dia(self, fecha, historial_semanal=None):
        try:
            ...
            base_ejercicios = {
                ...
                "weights": self.base_ejercicios_weights,
            ...
            }.get(self.modelo.ejercicios_type if self.modelo and self.modelo.ejercicios_type in ["bodyweight", "weights", "new_bodyweight", "mixta", "correccion"] else "bodyweight", self.base_ejercicios_bodyweight)
