...
class Modelo:
    def __init__(self, config_file='entreno_verano.json', use_auth=False):
        try:
            ...
            self.meta_km = {}
            self.ejercicios_type = "bodyweight"  # Manteniendo ejercicios_type para compatibilidad
            self.km_corridos = {}
    ...
    def cargar_datos(self):
        try:
            ...
            if user_data.exists:
                ...
                self.ejercicios_type = data.get('ejercicios_type', 'bodyweight')  # Manteniendo ejercicios_type
    ...
    def guardar_datos(self):
        try:
            ...
            user_ref.set({
                ...
                'ejercicios_type': self.ejercicios_type,  # Manteniendo ejercicios_type
    ...
    def nuevo_usuario(self, nombre, uid=None):
        ...
        self.meta_km = {}
        self.ejercicios_type = "bodyweight"  # Manteniendo ejercicios_type
        self.km_corridos = {}
        self.tiempo_corridos = {}
        self.ejercicios_completados = {}
        self.ejercicios_personalizados = []
